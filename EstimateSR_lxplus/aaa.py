...
# Access the 'expdata' directory
    ...
    var_looping_info = [
    { 'var':'bALL_Pho_pt'         , 'figNAME':'h_barrel_Pho_pt.pdf'            ,'ySCALE':'log'   , 'xLABEL':'$p^{\gamma}_{T} (GeV)$' },
    { 'var':'bALL_PhoEta'         , 'figNAME':'h_barrel_Pho_eta.pdf'           ,'ySCALE':'log'   , 'xLABEL':'$\eta^{\gamma}$' },
    { 'var':'bALL_PhoPhi'         , 'figNAME':'h_barrel_Pho_phi.pdf'           ,'ySCALE':'log'   , 'xLABEL':'$\phi^{\gamma}$' },
    { 'var':'bALL_PNetB'          , 'figNAME':'h_barrel_PNetB.pdf'             ,'ySCALE':'log'   , 'xLABEL':'bScore (PNet)' },
    { 'var':'bALL_PNetCvsB'       , 'figNAME':'h_barrel_PNetCvsB.pdf'          ,'ySCALE':'log'   , 'xLABEL':'CvsB (PNet)'   },
    { 'var':'bALL_PNetCvsL'       , 'figNAME':'h_barrel_PNetCvsL.pdf'          ,'ySCALE':'log'   , 'xLABEL':'CvsL (PNet)'   },

    { 'var':'bALL_ParTB'          , 'figNAME':'h_barrel_ParTB.pdf'             ,'ySCALE':'log'   , 'xLABEL':'bScore (ParT)' },
    { 'var':'bALL_ParTCvsB'       , 'figNAME':'h_barrel_ParTCvsB.pdf'          ,'ySCALE':'log'   , 'xLABEL':'CvsB (ParT)'   },
    { 'var':'bALL_ParTCvsL'       , 'figNAME':'h_barrel_ParTCvsL.pdf'          ,'ySCALE':'log'   , 'xLABEL':'CvsL (ParT)'   },

    { 'var':'bALL_DeepFlavourB'   , 'figNAME':'h_barrel_DeepFlavourB.pdf'      ,'ySCALE':'log'   , 'xLABEL':'bScore (DeepFlavour)' },
    { 'var':'bALL_DeepFlavourCvsB', 'figNAME':'h_barrel_DeepFlavourCvsB.pdf'   ,'ySCALE':'log'   , 'xLABEL':'CvsB (DeepFlavour)'   },
    { 'var':'bALL_DeepFlavourCvsL', 'figNAME':'h_barrel_DeepFlavourCvsL.pdf'   ,'ySCALE':'log'   , 'xLABEL':'CvsL (DeepFlavour)'   },

    { 'var':'eALL_Pho_pt'         , 'figNAME':'h_endcap_Pho_pt.pdf'            ,'ySCALE':'log'   , 'xLABEL':'$p^{\gamma}_{T} (GeV)$' },
    { 'var':'eALL_PhoEta'         , 'figNAME':'h_endcap_Pho_eta.pdf'           ,'ySCALE':'log'   , 'xLABEL':'$\eta^{\gamma}$' },
    { 'var':'eALL_PhoPhi'         , 'figNAME':'h_endcap_Pho_phi.pdf'           ,'ySCALE':'log'   , 'xLABEL':'$\phi^{\gamma}$' },
    { 'var':'eALL_PNetB'          , 'figNAME':'h_endcap_PNetB.pdf'             ,'ySCALE':'log'   , 'xLABEL':'bScore (PNet)' },
    { 'var':'eALL_PNetCvsB'       , 'figNAME':'h_endcap_PNetCvsB.pdf'          ,'ySCALE':'log'   , 'xLABEL':'CvsB (PNet)'   },
    { 'var':'eALL_PNetCvsL'       , 'figNAME':'h_endcap_PNetCvsL.pdf'          ,'ySCALE':'log'   , 'xLABEL':'CvsL (PNet)'   },
                                                                                                                                     
    { 'var':'eALL_ParTB'          , 'figNAME':'h_endcap_ParTB.pdf'             ,'ySCALE':'log'   , 'xLABEL':'bScore (ParT)' },
    { 'var':'eALL_ParTCvsB'       , 'figNAME':'h_endcap_ParTCvsB.pdf'          ,'ySCALE':'log'   , 'xLABEL':'CvsB (ParT)'   },
    { 'var':'eALL_ParTCvsL'       , 'figNAME':'h_endcap_ParTCvsL.pdf'          ,'ySCALE':'log'   , 'xLABEL':'CvsL (ParT)'   },
                                                                                                                                     
    { 'var':'eALL_DeepFlavourB'   , 'figNAME':'h_endcap_DeepFlavourB.pdf'      ,'ySCALE':'log'   , 'xLABEL':'bScore (DeepFlavour)' },
    { 'var':'eALL_DeepFlavourCvsB', 'figNAME':'h_endcap_DeepFlavourCvsB.pdf'   ,'ySCALE':'log'   , 'xLABEL':'CvsB (DeepFlavour)'   },
    { 'var':'eALL_DeepFlavourCvsL', 'figNAME':'h_endcap_DeepFlavourCvsL.pdf'   ,'ySCALE':'log'   , 'xLABEL':'CvsL (DeepFlavour)'   },
    ]
    sf = -1.
