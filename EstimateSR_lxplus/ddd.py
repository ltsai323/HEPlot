...
# Access the 'expdata' directory
    ...
    var_looping_info = [
            { 'var': 'b_MyMVA',           'xLABEL': 'BDTG Score'                 , 'figNAME': 'hB_BDT.pdf'         ,'ySCALE': 'log'   },
            ...
            { 'var': 'e_MyMVA',           'xLABEL': 'BDTG Score'                 , 'figNAME': 'hE_BDT.pdf'         ,'ySCALE': 'log'   },
    ...
    for var_info in var_looping_info:
        ...
        hsignO= getHistSet(f_sign, orig_sig_plot_name     , desc='original sign', color='burlywood')
