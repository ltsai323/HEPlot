...
// Wed Aug 28 20:37:14 2024 by ROOT version 6.30/06
// from TTree EventTree/Event data (tag V10_06_30_01)
// found on file: ggtree_mc_107.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<float>   *phoTrkIsoHollowConeDR03;
   ...
   Int_t           nConv;
   vector<int>     *convNTrks;
   vector<float>   *convVtxRadius;
   vector<float>   *convVtxX;
   vector<float>   *convVtxY;
   vector<float>   *convVtxZ;
   vector<float>   *convTrksPin0X;
   vector<float>   *convTrksPin0Y;
   vector<float>   *convTrksPin0Z;
   vector<float>   *convFitPairPX;
   vector<float>   *convFitPairPY;
   vector<float>   *convFitPairPZ;
   vector<float>   *convFitPairM;
   vector<float>   *convFitProb;
   vector<float>   *convD0;
   vector<float>   *convDz;
   vector<float>   *convL0;
   vector<float>   *convLz;
   ...
   vector<float>   *bcEta;
   vector<float>   *bcPhi;
   vector<float>   *bcSigmaIEtaIEta;
   vector<float>   *bcSigmaIEtaIPhi;
   vector<float>   *bcR9;
   vector<float>   *bcR15;
   vector<float>   *bcR22;
   vector<float>   *bcR25;
   ...
   vector<float>   *gsfEta;
   vector<float>   *gsfPhi;
   vector<int>     *gsfCharge;
   vector<int>     *gsfLayers;
   vector<int>     *gsfMissHits;
   vector<float>   *gsfD0;
   vector<float>   *gsfDz;
   Int_t           nMu;
   vector<float>   *muPt;
   ...
   vector<float>   *jetDeepFlavourTags_b;
   vector<float>   *jetDeepFlavourTags_c;
   vector<float>   *jetDeepFlavourTags_g;
   vector<float>   *jetDeepFlavourTags_lepb;
   vector<float>   *jetDeepFlavourTags_bb;
   vector<float>   *jetDeepFlavourTags_uds;
   vector<float>   *jetDeepCSVDiscriminatorTags_BvsAll;
   vector<float>   *jetDeepCSVDiscriminatorTags_CvsB;
   vector<float>   *jetDeepCSVDiscriminatorTags_CvsL;
   ...
   vector<float>   *jetSecVtxMass;
   vector<int>     *jetSecVtxNtrks;
   vector<float>   *jetSecVtx3DVal;
   vector<float>   *jetSecVtx3DErr;
   ...
   TBranch        *b_phoTrkIsoHollowConeDR03;   //!
   ...
   TBranch        *b_nConv;   //!
   TBranch        *b_convNTrks;   //!
   TBranch        *b_convVtxRadius;   //!
   TBranch        *b_convVtxX;   //!
   TBranch        *b_convVtxY;   //!
   TBranch        *b_convVtxZ;   //!
   TBranch        *b_convTrksPin0X;   //!
   TBranch        *b_convTrksPin0Y;   //!
   TBranch        *b_convTrksPin0Z;   //!
   TBranch        *b_convFitPairPX;   //!
   TBranch        *b_convFitPairPY;   //!
   TBranch        *b_convFitPairPZ;   //!
   TBranch        *b_convFitPairM;   //!
   TBranch        *b_convFitProb;   //!
   TBranch        *b_convD0;   //!
   TBranch        *b_convDz;   //!
   TBranch        *b_convL0;   //!
   TBranch        *b_convLz;   //!
   ...
   TBranch        *b_bcEta;   //!
   TBranch        *b_bcPhi;   //!
   TBranch        *b_bcSigmaIEtaIEta;   //!
   TBranch        *b_bcSigmaIEtaIPhi;   //!
   TBranch        *b_bcR9;   //!
   TBranch        *b_bcR15;   //!
   TBranch        *b_bcR22;   //!
   TBranch        *b_bcR25;   //!
   ...
   TBranch        *b_jetNNP;   //!
   TBranch        *b_jetMUF;   //!
   TBranch        *b_jetSecVtxPt;   //!
   TBranch        *b_jetSecVtxMass;   //!
   TBranch        *b_jetSecVtxNtrks;   //!
   TBranch        *b_jetSecVtx3DVal;   //!
   TBranch        *b_jetSecVtx3DErr;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("ggtree_mc_107.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/Users/noises/Downloads/ggtree_mc_107.root");
      }
...
void hi::Init(TTree *tree)
{
   ...
   jetDeepFlavourTags_b = 0;
   jetDeepFlavourTags_c = 0;
   jetDeepFlavourTags_g = 0;
   jetDeepFlavourTags_lepb = 0;
   jetDeepFlavourTags_bb = 0;
   jetDeepFlavourTags_uds = 0;
   jetDeepCSVDiscriminatorTags_BvsAll = 0;
   jetDeepCSVDiscriminatorTags_CvsB = 0;
   jetDeepCSVDiscriminatorTags_CvsL = 0;
   jetPartonID = 0;
   jetHadFlvr = 0;
   jetGenJetEn = 0;
   jetGenJetPt = 0;
   ...
   fChain->SetBranchAddress("pupthat_max", &pupthat_max, &b_pupthat_max);
   ...
   fChain->SetBranchAddress("phoTrkIsoHollowConeDR03", &phoTrkIsoHollowConeDR03, &b_phoTrkIsoHollowConeDR03);
   ...
   fChain->SetBranchAddress("convNTrks", &convNTrks, &b_convNTrks);
   fChain->SetBranchAddress("convVtxRadius", &convVtxRadius, &b_convVtxRadius);
   ...
   fChain->SetBranchAddress("convTrksPin0X", &convTrksPin0X, &b_convTrksPin0X);
   fChain->SetBranchAddress("convTrksPin0Y", &convTrksPin0Y, &b_convTrksPin0Y);
   fChain->SetBranchAddress("convTrksPin0Z", &convTrksPin0Z, &b_convTrksPin0Z);
   fChain->SetBranchAddress("convFitPairPX", &convFitPairPX, &b_convFitPairPX);
   fChain->SetBranchAddress("convFitPairPY", &convFitPairPY, &b_convFitPairPY);
   fChain->SetBranchAddress("convFitPairPZ", &convFitPairPZ, &b_convFitPairPZ);
   fChain->SetBranchAddress("convFitPairM", &convFitPairM, &b_convFitPairM);
   fChain->SetBranchAddress("convFitProb", &convFitProb, &b_convFitProb);
   fChain->SetBranchAddress("convD0", &convD0, &b_convD0);
   fChain->SetBranchAddress("convDz", &convDz, &b_convDz);
   fChain->SetBranchAddress("convL0", &convL0, &b_convL0);
   ...
   fChain->SetBranchAddress("bcSigmaIEtaIEta", &bcSigmaIEtaIEta, &b_bcSigmaIEtaIEta);
   fChain->SetBranchAddress("bcSigmaIEtaIPhi", &bcSigmaIEtaIPhi, &b_bcSigmaIEtaIPhi);
   fChain->SetBranchAddress("bcR9", &bcR9, &b_bcR9);
   fChain->SetBranchAddress("bcR15", &bcR15, &b_bcR15);
   fChain->SetBranchAddress("bcR22", &bcR22, &b_bcR22);
   fChain->SetBranchAddress("bcR25", &bcR25, &b_bcR25);
   ...
   fChain->SetBranchAddress("gsfLayers", &gsfLayers, &b_gsfLayers);
   fChain->SetBranchAddress("gsfMissHits", &gsfMissHits, &b_gsfMissHits);
   fChain->SetBranchAddress("gsfD0", &gsfD0, &b_gsfD0);
   ...
   fChain->SetBranchAddress("jetSecVtxPt", &jetSecVtxPt, &b_jetSecVtxPt);
   fChain->SetBranchAddress("jetSecVtxMass", &jetSecVtxMass, &b_jetSecVtxMass);
   fChain->SetBranchAddress("jetSecVtxNtrks", &jetSecVtxNtrks, &b_jetSecVtxNtrks);
   fChain->SetBranchAddress("jetSecVtx3DVal", &jetSecVtx3DVal, &b_jetSecVtx3DVal);
   fChain->SetBranchAddress("jetSecVtx3DErr", &jetSecVtx3DErr, &b_jetSecVtx3DErr);
   Notify();
}
