...
def yield_to_xs_scale_factor(binning:Binning, effTfile:ROOT.TFile) -> float:
    w_peta = pho_eta_width(binning.pEtaBin)
    w_jeta = jet_eta_width(binning.jEtaBin)
    ge = effTfile.Get('bin00L_WPcL_eff')
...
if __name__ == "__main__":
    ...
    with open(inCSV, 'r') as fIN:
        for csv_entry in csv.DictReader(fIN):
            ...
            sf0 = yield_to_xs_scale_factor(entry.binning,efftfile)
