...
PLOT_STYLES = {
        ...
        'data'  : style_marker(linestyle='None', color=light_colors(0),marker='o', barsabove=True, markersize=MARKER_SIZE),
        ...
        'hist' : style_fill(histtype='stepfilled', edgecolor='1', linewidth=0.5, color=light_colors(0), alpha=0.7),
        'hist0': style_fill(histtype='stepfilled', edgecolor='1', linewidth=0.5, color=light_colors(0), alpha=0.7),
        'hist1': style_fill(histtype='stepfilled', edgecolor='1', linewidth=0.5, color=light_colors(1), alpha=0.7),
        'hist2': style_fill(histtype='stepfilled', edgecolor='1', linewidth=0.5, color=light_colors(2), alpha=0.7),
        'hist3': style_fill(histtype='stepfilled', edgecolor='1', linewidth=0.5, color=light_colors(3), alpha=0.7),
        'hist4': style_fill(histtype='stepfilled', edgecolor='1', linewidth=0.5, color=light_colors(4), alpha=0.7),
        'histBKG': style_fill(histtype='stepfilled', edgecolor='1', linewidth=0.5, color='#777581', alpha=0.7),
